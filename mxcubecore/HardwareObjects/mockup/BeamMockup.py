...
class BeamMockup(AbstractBeam):
    ...
    def init(self):
        ...
        self._beam_position_on_screen = eval(self.get_property('beam_position', [612, 512]))
        self._beam_shape = self.get_property('beam_shape', 'ellipse')
        self._beam_width_nominal = self.get_property('beam_width', 0.010)
        self._beam_height_nominal = self.get_property('beam_height', 0.005)
