...
class AbstractBeam(HardwareObject):
    ...
    def __init__(self, name):
        ...
        self._beam_width_nominal = None
        self._beam_height_nominal = None
    ...
    def evaluate_beam_info(self):
        ...
        size_x = min(
            self._beam_size_dict["aperture"][0], self._beam_size_dict["slits"][0], self._beam_width_nominal
        )
        size_y = min(
            self._beam_size_dict["aperture"][1], self._beam_size_dict["slits"][1], self._beam_height_nominal
        )
