...
__credits__ = ["EMBL Hamburg, SOLEIL"]
__license__ = "LGPLv3+"
...
class SOLEILOnlineProcessing(AbstractOnlineProcessing):
    """
    ...
    def init(self):
        ...
        #print('chan_dozor_average_i', self.chan_dozor_average_i.get_value(force=True))
        ...
        #print('chan_dozor_pass', self.chan_dozor_pass.get_value(force=True))
        ...
        #print('chan_frame_count', self.chan_frame_count.get_value(force=True))
