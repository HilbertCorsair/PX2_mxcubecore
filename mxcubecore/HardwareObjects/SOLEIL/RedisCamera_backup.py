...
class RedisCamera(AbstractVideoDevice):
    ...
    def init(self):
        ...
        self.raw_image_dimensions = [1224, 1024] #[1360, 1024]
        self.scale = 1
    ...
    def do_image_polling(self, sleep_time=0.025):
    ...
    def get_last_image(self):
        ...
        if simplejpeg.is_jpeg(last_image_data):
            img = simplejpeg.decode_jpeg(last_image_data).reshape((self.image_dimensions[0], self.image_dimensions[1], 3))
